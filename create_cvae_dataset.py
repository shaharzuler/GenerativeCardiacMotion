...
img_paths  = [path for path in all_paths if "template_img" in path]#all_paths[len(all_paths)//3:]
flow_paths = [path for path in all_paths if "flow" in path]#all_paths[:len(all_paths)//3]
