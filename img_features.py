...
def extract_img_features(img_path, flow_path, req_shape=(86,86,76)):
    ...
    x1_p, data = infer_backbone(
        ...
        template_LV_seg_path=None,#img_path.replace("_img_","_mask_"),#'/home/shahar/projects/CVAE_proj/CVAE/data_source/image_skewed_thetas_82.5_-27.5_rs_0.9_0.9_h_0.91_linear_mask_True_blur_radious_1.npy',
        unlabeled_LV_seg_path=None,#img_path.replace("_img_","_mask_"),#'/home/shahar/projects/CVAE_proj/CVAE/data_source/image_skewed_thetas_82.5_-27.5_rs_0.9_0.9_h_0.91_linear_mask_True_blur_radious_1.npy',
        template_shell_seg_path=None,#img_path.replace("_img_","_mask_"),#'/home/shahar/projects/CVAE_proj/CVAE/data_source/image_skewed_thetas_82.5_-27.5_rs_0.9_0.9_h_0.91_linear_mask_True_blur_radious_1.npy',
        unlabeled_shell_seg_path=None,#img_path.replace("_img_","_mask_"),#'/home/shahar/projects/CVAE_proj/CVAE/data_source/image_skewed_thetas_82.5_-27.5_rs_0.9_0.9_h_0.91_linear_mask_True_blur_radious_1.npy',
